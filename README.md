...
- **Проекты** — карточки с размером, числом файлов и датой изменения.
  ...
  «Скачать» создаёт временный tar.gz, отдаёт его браузеру и сразу удаляет с сервера.
...
| `BACKUP_PASSWORD` | Пароль шифрования архивов (AES-256), пусто = без шифрования | ✅ в течение минуты |
