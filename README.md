...
- 🤖 **7 инструментов для MCP-клиента** — `run_command`, `write_file`, `read_file`, `list_files`, `search_in_files`, `delete_file`, `move_file`
...
- 🗄 **Бэкапы в Telegram** — по расписанию или кнопкой, шифрование AES-256, восстановление в один клик
